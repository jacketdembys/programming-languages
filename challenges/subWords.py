...
def find_longest_word_in_string(letters, words):
    ...
    for word in sorted(words, key=lambda w: len(w), reverse=True):
        ...
        # but this is very Python-ic.
            ...
            print("Here 4:", possible_positions)
...
if __name__ == '__main__':
    #rint(subdict(sys.argv[1], sys.argv[2:]))

    letters = "pppablee"
    words = {"able", "ale", "apple", "bale", "kangaroo", "apppple"}

    longest_word = find_longest_word_in_string(letters, words)

    print("longest word found is: ", longest_word)